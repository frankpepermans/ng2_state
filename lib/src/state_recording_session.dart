...
class StateRecordingSession {
  final List<Tuple2<Map<String, StateContainer>, int>> aggregatedStates =
      <Tuple2<Map<String, StateContainer>, int>>[];

  StreamSubscription<Tuple2<Map<String, StateContainer>, int>> subscription;

  void add(Tuple2<Map<String, StateContainer>, int> container) =>
      aggregatedStates.add(container);
}
